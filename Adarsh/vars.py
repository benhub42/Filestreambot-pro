...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '104.28.249.52'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '104.28.249.52:80')) if not ON_HEROKU or getenv('FQDN', '') else APP_NAME+'.herokuapp.com'
